...
export function ContactSuccessMessage({
  ...
  const successClassName = ["theme-form-success", className].filter(Boolean).join(" ");

  return (
    <div className={successClassName} role="status">
      <img src="/theme-assets/thank-you.svg" alt="" aria-hidden="true" />
      <h2 id={headingId}>We Heard You!</h2>
  ...
  return (
    <div className="modal-backdrop">
      <dialog
        ...
        data-lenis-prevent
        aria-modal="true"
        aria-labelledby={status === "success" ? "contact-modal-success-title" : "contact-modal-title"}
      >
        ...
        {status === "success" ? (
          <ContactSuccessMessage className="contact-modal__success" headingId="contact-modal-success-title" />
        ) : (
          <>
